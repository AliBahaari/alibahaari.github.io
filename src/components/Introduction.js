  ...
  return (
    <div className="introduction">
      ...
      <p>
        ...
        Designing such as Logos, Vectors, Icons, etc.. Surely, Adobe XD and
        Figma have been using for UIs. At the end, I analyze Financial Markets.
        I use different approaches to do so simultaneously. Favorites are
        Elliott, MRM and Ichimoku.
      </p>
    </div>
  )
}
